...
только просмотр уже запущенной проверки. Celery-задача ставится в очередь при
отправке работы студентом. После завершения в деталях сдачи доступны статус, структурированный

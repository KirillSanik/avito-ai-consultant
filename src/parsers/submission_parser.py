...
class SubmissionParser:
    ignored_directories = {"data", "dataset", "datasets", "rawdata", "artifacts", "logs", "cache", "git", "venv", "pycache"}
    ignored_extensions = {".csv", ".parquet", ".feather", ".h5", ".hdf5", ".pkl", ".npy", ".npz", ".db", ".sqlite", ".zip", ".tar", ".exe", ".png", ".jpg"}
    supported_repository_extensions = {".py", ".ipynb", ".sql", ".sh", ".go", ".md", ".docx", ".pdf", ".xlsx"}
    excluded_task_names = {"описаниезадания", "taskdescription", "assignmentdescription"}

...
class SubmissionData(BaseModel):
    ...
    file_tree: list[str] = Field(default_factory=list, description="Пути файлов, входящих в локальную сдачу или репозиторий.")
    ...
    excel_audit: Optional[ExcelAudit] = Field(default=None, description="Результат аудита формул Excel, если применимо.")
